...
urlpatterns = [
    ...
    path('clientes/<int:client_id>/editar/', views.client_edit_page_view, name='client_edit'),
    path('clientes/<int:client_id>/detalle/', views.client_detail_api_view, name='client_detail'),
    path('clientes/<int:client_id>/actualizar/', views.client_update_api_view, name='client_update'),
